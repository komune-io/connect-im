...
open class PolicyEnforcer {
    ...
    protected suspend fun check(action: String, hasAccess: suspend (AuthedUserDTO?) -> Boolean) =
        enforce { authedUser ->
    ...
    protected suspend fun checkAuthed(action: String, hasAccess: suspend (AuthedUserDTO) -> Boolean = { true }) =
